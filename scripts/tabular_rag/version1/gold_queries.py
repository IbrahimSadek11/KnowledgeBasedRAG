...
GOLD_QUERIES = {
    ...
    "Q4": "SELECT event_id FROM event_entries WHERE horse_id = 'Horse_Dakota';",
    ...
    "Q17": "SELECT rider_id FROM horse_rider_associations WHERE horse_id = 'Horse_Dakota';",
    "Q18": "SELECT rider_id FROM horse_rider_associations WHERE horse_id = 'Horse_Naya';",
    ...
    "Q67": "SELECT ee.event_id, COUNT(DISTINCT ee.horse_id) - COALESCE((SELECT COUNT(*) FROM event_participations ep WHERE ep.event_id = ee.event_id), 0) AS gap FROM event_entries ee GROUP BY ee.event_id HAVING gap > 0 ORDER BY gap DESC LIMIT 1;",
