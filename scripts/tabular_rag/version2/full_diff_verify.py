...
For every one of the twelve tables, this pulls a fresh "ground truth" from Neo4j
...
EXPECTED_TOTAL = (
    50 + 20 + 207 + 355 + 101 + 108  # core tables
    + 2    # objectives
    + 1    # seasons
    + 27   # people
    + 25   # riders
...
# (ASSOCIATIONS_CYPHER removed in version2 — horse_rider_associations dropped.)
...
# (EVENT_ENTRIES_CYPHER removed in version2 — event_entries dropped.)
...
def main():
    ...
    sink("\n=== FINAL SUMMARY ===")
    sink(f"  total rows checked across all twelve tables: {total_rows} (expected {EXPECTED_TOTAL})")
