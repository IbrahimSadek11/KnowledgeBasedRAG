...
GOLD_QUERIES = {
    ...
    "Q4": "SELECT DISTINCT event_id FROM event_participations WHERE horse_id = 'Horse_Dakota';",
    "Q5": "SELECT training_id FROM trainings WHERE horse_id = 'Horse_Dakota';",
    ...
    "Q10": "SELECT DISTINCT e.event_id, e.location, e.category, e.event_date, e.discipline, t.stage_type FROM trainings t JOIN events e ON t.event_id = e.event_id WHERE t.horse_id = 'Horse_Dakota';",
    "Q11": "SELECT COUNT(*) FROM sensors WHERE horse_id = 'Horse_Dakota';",
    ...
    "Q13": "SELECT DISTINCT sensor_type FROM sensors WHERE horse_id = 'Horse_Dakota';",
    ...
    "Q17": "SELECT DISTINCT rider_id FROM event_participations WHERE horse_id = 'Horse_Dakota';",
    "Q18": "SELECT DISTINCT rider_id FROM event_participations WHERE horse_id = 'Horse_Naya';",
    ...
    "Q31": "SELECT rider_id, rank FROM event_participations WHERE horse_id = 'Horse_Dakota' AND event_id = 'Event_SJ_01';",
    ...
    # rank IS NULL = entry without result (schema-native; no event_entries needed).
    "Q62": "SELECT DISTINCT e.event_id, e.location, e.category, e.event_date, e.discipline FROM events e JOIN event_participations ep ON e.event_id = ep.event_id WHERE ep.rank IS NULL;",
    "Q63": "SELECT event_id, COUNT(*) AS cnt FROM event_participations GROUP BY event_id HAVING COUNT(*) = (SELECT MAX(c) FROM (SELECT COUNT(*) AS c FROM event_participations GROUP BY event_id));",
    "Q64": "SELECT horse_id, COUNT(DISTINCT event_id) AS event_count FROM event_participations GROUP BY horse_id;",
    "Q65": "SELECT (SELECT COUNT(*) FROM event_participations WHERE status != 'Terminé') AS unranked, (SELECT COUNT(*) FROM event_participations) AS total;",
    ...
    "Q67": "SELECT event_id, unranked_count FROM (SELECT event_id, COUNT(*) AS unranked_count FROM event_participations WHERE status != 'Terminé' GROUP BY event_id) WHERE unranked_count = (SELECT MAX(cnt) FROM (SELECT COUNT(*) AS cnt FROM event_participations WHERE status != 'Terminé' GROUP BY event_id)) ORDER BY event_id;",
    # LIKE (not GLOB): '_' is a single-char wildcard in LIKE; GLOB uses '?'/'*'.
    # Counts event_date values that are NOT YYYY-MM-DD shaped.
    "Q74": "SELECT COUNT(*) FROM events WHERE event_date NOT LIKE '____-__-__';",
    ...
    "Q82": "SELECT sensor_id, objective_id FROM sensors WHERE horse_id = 'Horse_Dakota';",
    ...
    "Q91": "SELECT event_id, rank FROM event_participations WHERE horse_id = 'Horse_Auroch';",
    ...
    "Q98": "SELECT COUNT(*) FROM event_participations WHERE status != 'Terminé';",
